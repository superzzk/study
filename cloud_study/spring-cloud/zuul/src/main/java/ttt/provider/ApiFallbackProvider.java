...
public class ApiFallbackProvider implements FallbackProvider {
    ...
    /**
     * 该Provider应用的Route ID，如果设置为 * ，那就对所有路由生效
     */
    @Override
    ...
    public ClientHttpResponse fallbackResponse(String route, Throwable cause) {
        logger.warning(String.format("route:%s,exceptionType:%s,stackTrace:%s",
                route, cause.getClass().getName(), cause.getStackTrace()));
        String message = "";
