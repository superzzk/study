...
import redis_study.chapter.seven.gossipserver.commands.MessageCommand;
import redis_study.chapter.seven.gossipserver.commands.SetCommand;
...
//                        command.setName(node.getNodename());
//                        MapListToken newMapListToken = mapListToken.removeElement("command");
//                        CheckResult result = command.execute(new CommandTokens("kill " + node.getNodename()));
//                        System.out.println(result.getResult());
//                        System.out.println(result.getReason());
