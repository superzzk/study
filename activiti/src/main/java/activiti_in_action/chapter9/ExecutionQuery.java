...
public class ExecutionQuery {
	...
	public static void main(String[] args) {
		...
		// 部署流程描述文件
		repositoryService.createDeployment().addClasspathResource("activiti_in_action/chapter9/ExecutionQuery.bpmn").deploy();
		//设置参数
		...
		// 开始流流程
		ProcessInstance pi1 = runtimeService.startProcessInstanceByKey("testProcess", "businessKey1", vars1);
		ProcessInstance pi2 = runtimeService.startProcessInstanceByKey("testProcess", "businessKey2", vars2);
		ProcessInstance pi3 = runtimeService.startProcessInstanceByKey("testProcess", "businessKey3", vars3);
		// 使用执行流查询方法
